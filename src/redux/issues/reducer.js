...
const initialState = {
    issues: [ {
        ...
        description: 'Hi All, I am trying to create a new app using create-react-app command. Below is the command used and the command is getting stuck in installing react,  I have Following versions: I tried clearing cache, re-installing node.js, restarted the system. My internet speed is fine. I dont know what the issue is. Could someone please help how can I get an app created? Thanks in advance! Harry',
        labels: [
            {id: 1, title: 'CLA Signed', bgc: '#009900'},
        ],
        comments: [
            {id:1, comment: 'If you\'ve previously installed create-react-app globally via npm install -g create-react-app, then uninstall the package using npm uninstall -g create-react-app to ensure that npx always uses the latest version.'},
            {id:2, comment: 'Thanks for your concern Well i tried it but it cound not resolve the issue'},
        ],
        isOpen: false
    },
    {
